...
${FREESURFER_HOME}/bin/mri_label2vol --seg ${SUBJECTS_DIR}/${study}_${id}/mri/aseg.mgz --temp ${SUBJECTS_DIR}/${study}_${id}/mri/rawavg.mgz --o ${dir}/${id}_tmp_aseg.mgz --regheader ${SUBJECTS_DIR}/${study}_${id}/mri/aseg.mgz
...
#Now get thw WM
${FREESURFER_HOME}/bin/mri_label2vol --seg ${SUBJECTS_DIR}/${study}_${id}/mri/wm.mgz --temp ${SUBJECTS_DIR}/${study}_${id}/mri/rawavg.mgz --o ${dir}/${id}_tmp_wm.mgz --regheader ${SUBJECTS_DIR}/${study}_${id}/mri/wm.mgz
