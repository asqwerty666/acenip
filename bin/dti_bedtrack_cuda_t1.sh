...
Usage() {                      
    echo ""                                                                                                                                                              
    echo "Usage: dti_bedtrack.sh  <project> <name> <working dir>"
    echo ""                                                                                                                                                              
...
antsApplyTransforms -d 3 -i ${w_dir}/${pollo}_aseg.nii.gz -r ${w_dir}/${pollo}_dti_b0.nii.gz -t ${td}/${pollo}_epi_reg_ANTS.mat -n GenericLabel -o ${td}/${pollo}_aseg_warped.nii.gz
###########################################
