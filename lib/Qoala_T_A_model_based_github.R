...
inputFolder <- "/nas/data/facehbi/qoala/"
# Create output directory if it doesnt exist  
outputFolder <- "/nas/data/facehbi/qqc/" 
...
setwd(inputFolder)
dataset_name <- "facehbi" # Provide name of your study and/or dataset (same as dataset name in Stats2Table script)
stats2Table <- read.csv(paste("FreeSurfer_Output_", dataset_name, ".csv", sep=""), header=T, row.names=1)
test_data <- stats2Table
dataset_name <- "facehbi"
